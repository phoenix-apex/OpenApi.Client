...
namespace DA.Systems.Cube.Norsk.Model
{
    ...
    /// ShipperAddress
    /// </summary>
    [DataContract(Name = "ShipperAddress")]
    public class ShipperAddress : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="iOSS">Government Issued IOSS Number, used for shipping to the EU with shipments under 150EUR..</param>
        public ShipperAddress(string contactName = default(string), string company = default(string), string address1 = default(string), string address2 = default(string), string address3 = default(string), string city = default(string), string division = default(string), string email = default(string), string divisionCode = default(string), string phoneNumber = default(string), string fax = default(string), string zipcode = default(string), string mobileNumber = default(string), string countryCode = default(string), string vAT = default(string), string eORI = default(string), string taxId = default(string), string iOSS = default(string))
        {
            // to ensure "contactName" is required (not null)
            if (contactName == null)
            {
                throw new ArgumentNullException("contactName is a required property for ShipperAddress and cannot be null");
            }
            ContactName = contactName;
            // to ensure "address1" is required (not null)
            if (address1 == null)
            {
                throw new ArgumentNullException("address1 is a required property for ShipperAddress and cannot be null");
            }
            Address1 = address1;
            // to ensure "city" is required (not null)
            if (city == null)
            {
                throw new ArgumentNullException("city is a required property for ShipperAddress and cannot be null");
            }
            City = city;
            // to ensure "countryCode" is required (not null)
            if (countryCode == null)
            {
                throw new ArgumentNullException("countryCode is a required property for ShipperAddress and cannot be null");
            }
        ...
        /// <summary>
        /// Government Issued IOSS Number, used for shipping to the EU with shipments under 150EUR.
        /// </summary>
        /// <value>Government Issued IOSS Number, used for shipping to the EU with shipments under 150EUR.</value>
        [DataMember(Name = "IOSS", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  IOSS: ").Append(IOSS).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
