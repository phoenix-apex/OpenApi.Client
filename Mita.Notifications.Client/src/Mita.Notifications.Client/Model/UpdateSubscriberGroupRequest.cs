...
/// </summary>
[DataContract(Name = "UpdateSubscriberGroupRequest")]
public partial class UpdateSubscriberGroupRequest : IValidatableObject
{
    /// <summary>
    /// Initializes a new instance of the <see cref="UpdateSubscriberGroupRequest" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected UpdateSubscriberGroupRequest() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="UpdateSubscriberGroupRequest" /> class.
    /// </summary>
    /// <param name="name">Group Name (required).</param>
    public UpdateSubscriberGroupRequest(string name = default(string))
    {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for UpdateSubscriberGroupRequest and cannot be null");
            }
            this.Name = name;
        }
    ...
    public override string ToString()
    {
            ...
            sb.Append("class UpdateSubscriberGroupRequest {\n");
