...
/// Message Schedule
/// </summary>
[DataContract(Name = "UpdateScheduledMessageBatchRequest")]
public partial class UpdateScheduledMessageBatchRequest : IValidatableObject
{
    /// <summary>
    /// Initializes a new instance of the <see cref="UpdateScheduledMessageBatchRequest" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected UpdateScheduledMessageBatchRequest() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="UpdateScheduledMessageBatchRequest" /> class.
    /// </summary>
    /// <param name="scheduledDeliveryDate">The date and time when the message will be scheduled for delivery. (required).</param>
    public UpdateScheduledMessageBatchRequest(DateTimeOffset scheduledDeliveryDate = default(DateTimeOffset))
    {
    ...
    public override string ToString()
    {
            ...
            sb.Append("class UpdateScheduledMessageBatchRequest {\n");
