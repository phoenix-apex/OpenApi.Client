...
namespace Mita.Notifications.Client.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("Identità/NotificationsClient/1.0.0/dotnet");
            BasePath = "https://notifications-api.gov.mt";
        ...
        /// </summary>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("ReSharper", "VirtualMemberCallInConstructor")]
        public Configuration(IDictionary<string, string> defaultHeaders, IDictionary<string, string> apiKey, IDictionary<string, string> apiKeyPrefix, string basePath = "https://notifications-api.gov.mt") : this()
        {
        ...
        /// <summary>
        /// Gets or sets the key for SMG-V1-HMAC-SHA256 authentication.
        /// </summary>
        public string Key { get; set; }
        
        /// <summary>
        /// Gets or sets the secret for SMG-V1-HMAC-SHA256 authentication.
        /// </summary>
        ...
        {
            string report = "C# SDK (Mita.Notifications.Client) Debug Report:\n";
        ...
        public static IReadableConfiguration MergeConfigurations(IReadableConfiguration first, IReadableConfiguration second)
        {
            ...
            var config = new Configuration
            {
                ...
                Secret = second.Secret ?? first.Secret,
                ApiKey = apiKey,
