...
/// Message Request
/// </summary>
[DataContract(Name = "UpdateMessageBatchRequest")]
public partial class UpdateMessageBatchRequest : IValidatableObject
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="UpdateMessageBatchRequest" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected UpdateMessageBatchRequest() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="UpdateMessageBatchRequest" /> class.
    /// </summary>
    ...
    public UpdateMessageBatchRequest(List<MessageContent> messageContent = default(List<MessageContent>), string clientReference = default(string), MessageType messageType = default(MessageType), MessagePriority messagePriority = default(MessagePriority), Guid senderId = default(Guid), string callbackUrl = default(string), DateTimeOffset scheduledDeliveryDate = default(DateTimeOffset))
    {
            // to ensure "clientReference" is required (not null)
            if (clientReference == null)
            {
                throw new ArgumentNullException("clientReference is a required property for UpdateMessageBatchRequest and cannot be null");
            }
    ...
    public override string ToString()
    {
            ...
            sb.Append("class UpdateMessageBatchRequest {\n");
