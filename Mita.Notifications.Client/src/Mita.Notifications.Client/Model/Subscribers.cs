...
/// Subscribers object.
/// </summary>
[DataContract(Name = "Subscribers")]
public partial class Subscribers : IValidatableObject
{
    /// <summary>
    /// Initializes a new instance of the <see cref="Subscribers" /> class.
    /// </summary>
    /// <param name="page">page.</param>
    /// <param name="collection">Represents a Collection of Subscriber objects..</param>
    public Subscribers(Page page = default(Page), List<Subscriber> collection = default(List<Subscriber>))
    {
            this.Page = page;
    ...
    /// <summary>
    /// Represents a Collection of Subscriber objects.
    /// </summary>
    /// <value>Represents a Collection of Subscriber objects.</value>
    [DataMember(Name = "Collection", EmitDefaultValue = true)]
    public List<Subscriber> Collection { get; set; }
