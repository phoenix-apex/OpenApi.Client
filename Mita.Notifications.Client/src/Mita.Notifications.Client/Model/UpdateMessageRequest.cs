...
/// Message Request
/// </summary>
[DataContract(Name = "UpdateMessageRequest")]
public partial class UpdateMessageRequest : IValidatableObject
{
    ...
    /// <param name="attachments">Message attachment list.  Optional - Used only for e-mail message types or message types allowing an attachement..</param>
    ...
    public UpdateMessageRequest(Contact contact = default(Contact), string subject = default(string), string messageBody = default(string), List<Attachment> attachments = default(List<Attachment>), string clientReference = default(string), MessageType messageType = default(MessageType), MessagePriority messagePriority = default(MessagePriority), Guid senderId = default(Guid), string callbackUrl = default(string), DateTimeOffset scheduledDeliveryDate = default(DateTimeOffset))
    {
            // to ensure "contact" is required (not null)
            if (contact == null)
            {
                throw new ArgumentNullException("contact is a required property for UpdateMessageRequest and cannot be null");
            }
            this.Contact = contact;
            // to ensure "messageBody" is required (not null)
            if (messageBody == null)
            {
                throw new ArgumentNullException("messageBody is a required property for UpdateMessageRequest and cannot be null");
            }
            this.MessageBody = messageBody;
            // to ensure "clientReference" is required (not null)
            if (clientReference == null)
            {
                throw new ArgumentNullException("clientReference is a required property for UpdateMessageRequest and cannot be null");
            }
    ...
    /// <summary>
    /// Message attachment list.  Optional - Used only for e-mail message types or message types allowing an attachement.
    /// </summary>
    /// <value>Message attachment list.  Optional - Used only for e-mail message types or message types allowing an attachement.</value>
