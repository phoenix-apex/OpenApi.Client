...
/// </summary>
[DataContract(Name = "InboundMessages")]
public partial class InboundMessages : IValidatableObject
{
    /// <summary>
    /// Initializes a new instance of the <see cref="InboundMessages" /> class.
    /// </summary>
    /// <param name="page">page.</param>
    /// <param name="collection">Collection of Inbound Messages.</param>
    public InboundMessages(Page page = default(Page), List<InboundMessage> collection = default(List<InboundMessage>))
    {
            this.Page = page;
    ...
    /// </summary>
    /// <value>Collection of Inbound Messages</value>
    [DataMember(Name = "Collection", EmitDefaultValue = true)]
    public List<InboundMessage> Collection { get; set; }
    ...
    public override string ToString()
    {
            ...
            sb.Append("class InboundMessages {\n");
