...
namespace DA.Systems.Cube.Norsk.Model
{
    ...
    /// CollectionAddress
    /// </summary>
    [DataContract(Name = "CollectionAddress")]
    public class CollectionAddress : IValidatableObject
    {

        /// <summary>
        /// Gets or Sets PickupType
        /// </summary>
        [DataMember(Name = "PickupType", EmitDefaultValue = true)]
        public PickupType? PickupType { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectionAddress" /> class.
        /// </summary>
        ...
        /// <param name="packageLocation">packageLocation (required).</param>
        /// <param name="closeTime">closeTime (required).</param>
        /// <param name="pickupType">pickupType.</param>
        public CollectionAddress(string contactName = default(string), string company = default(string), string address1 = default(string), string address2 = default(string), string address3 = default(string), string city = default(string), string division = default(string), string email = default(string), string divisionCode = default(string), string phoneNumber = default(string), string fax = default(string), string zipcode = default(string), string mobileNumber = default(string), string countryCode = default(string), string packageLocation = default(string), LocalTime closeTime = default(LocalTime), PickupType? pickupType = default(PickupType?))
        {
            // to ensure "contactName" is required (not null)
            if (contactName == null)
            {
                throw new ArgumentNullException("contactName is a required property for CollectionAddress and cannot be null");
            }
            ContactName = contactName;
            // to ensure "address1" is required (not null)
            if (address1 == null)
            {
                throw new ArgumentNullException("address1 is a required property for CollectionAddress and cannot be null");
            }
            Address1 = address1;
            // to ensure "city" is required (not null)
            if (city == null)
            {
                throw new ArgumentNullException("city is a required property for CollectionAddress and cannot be null");
            }
            City = city;
            // to ensure "countryCode" is required (not null)
            if (countryCode == null)
            {
                throw new ArgumentNullException("countryCode is a required property for CollectionAddress and cannot be null");
            }
            CountryCode = countryCode;
            // to ensure "packageLocation" is required (not null)
            if (packageLocation == null)
            {
                throw new ArgumentNullException("packageLocation is a required property for CollectionAddress and cannot be null");
            }
            PackageLocation = packageLocation;
            // to ensure "closeTime" is required (not null)
            if (closeTime == null)
            {
                throw new ArgumentNullException("closeTime is a required property for CollectionAddress and cannot be null");
            }
            CloseTime = closeTime;
            Company = company;
            Address2 = address2;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectionAddress {\n");
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // PackageLocation (string) minLength
            if (PackageLocation != null && PackageLocation.Length < 1)
            {
                yield return new ValidationResult("Invalid value for PackageLocation, length must be greater than 1.", new [] { "PackageLocation" });
            }
