...
public class DeliveryReportsTests : IDisposable
{
    ...
    {
            // TODO uncomment below to test "IsType" DeliveryReports
            //Assert.IsType<DeliveryReports>(instance);
        }
